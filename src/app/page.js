...
function Home() {
  return (
    ...
    <div className='flex flex-col justify-center items-start gap-3 max-w-[80%]'>
      ...
      <Link href={"/account"} className='bg-white min-w-[60%] text-center hover:scale-[1.04] py-2 sm:px-6 sm:py-3 duration-150 transition-all text-[#f63555] rounded-lg font-bold'>Get Started</Link>
      </div>
      </div>
